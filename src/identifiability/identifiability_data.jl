PolySystem = Union{HomotopyContinuation.ModelKit.System, Vector{Nemo.QQPolyRingElem}}
...
# Fields
- `polynomial_system::Vector{Nemo.QQPolyRingElem	}`: The polynomial system.
- `polynomial_system_to_solve::PolySystem`: The polynomial system with derivatives substitutited and ready to be solved.
- `denominator::Nemo.QQPolyRingElem	`: The denominator of the polynomial system.
- `variables::Vector{Nemo.QQPolyRingElem	}`: The variables of the polynomial system.
...
- `basis::Vector{Nemo.QQPolyRingElem	}`: The transcendence basis of the polynomial system.
- `transcendence_basis_subs::Vector{Nemo.RingElem}`: The transcendence basis substitutions of the polynomial system.
- `weights::Dict{Nemo.QQPolyRingElem	, Int64}`: The weights of the variables used by SIAN to assess GroebnerBasis.
"""
mutable struct IdentifiabilityData
	full_polynomial_system::Vector{Nemo.QQPolyRingElem}
	polynomial_system::Vector{Nemo.QQPolyRingElem}
	polynomial_system_to_solve::PolySystem
	denomiantor::Nemo.QQPolyRingElem
	variables::Vector{Nemo.QQPolyRingElem}
	...
	basis::Vector{Nemo.QQPolyRingElem}
	weights::AbstractDict{Nemo.QQPolyRingElem, Int64}
